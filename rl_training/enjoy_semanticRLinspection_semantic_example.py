...
from src.config.task.inspection_task_semantic_example_config import (
    task_config_semantic_example as inspection_task_config,
)
from src.config.env.env_with_semantic_example import EnvWithSemanticExampleCfg
from src.config.robot.inspection_quad_config import InspectionQuadCfg


env_config_registry.register("env_with_semantic_example", EnvWithSemanticExampleCfg)
