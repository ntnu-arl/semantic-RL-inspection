...
from src.robot.robot_manager import RobotManagerIGE
...
class EnvManager(BaseManager):
    ...
    def prepare_sim(self):
        ...
        # set the camera follow to true
        if self.IGE_env.viewer is not None:
            self.IGE_env.viewer.camera_follow = True
    ...
    def step(self, actions, env_actions=None):
        ...
        self.global_tensor_dict["robot_prev_actions"] = self.global_tensor_dict["robot_actions"].clone()
